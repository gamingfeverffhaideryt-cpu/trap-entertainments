...
export default function TrapEntertainmentsWebsite() {
  ...
  // Smooth scaling effect configured safe for both mobile and desktop scroll-bounds
  ...
  return (
    <div className={`min-h-screen bg-black text-white font-sans selection:bg-amber-500 selection:text-black transition-opacity duration-1000 ease-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      {/* Hero Section - Upgraded to fluid vertical padding on mobile to prevent button clipping */}
      <section id="home" className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 py-20 md:py-0 text-center">
        ...
        <div 
          className="relative z-10 max-w-4xl w-full will-change-transform transition-all duration-300 ease-out"
          style={{
        ...
        >
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 px-4">
            <a
              href="#event"
              onClick={(e) => {
                e.preventDefault();
            ...
            <button 
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-2xl border border-amber-500/20 bg-neutral-900/40 px-8 py-4 text-base md:text-lg font-semibold backdrop-blur-sm transition-all duration-300 text-amber-400 hover:bg-gradient-to-r hover:from-amber-500 hover:to-yellow-400 hover:text-black hover:border-transparent hover:scale-[1.03] active:scale-95"
            >
      ...
      {/* About Section */}
      <section className="mx-auto max-w-6xl px-6 py-20 border-t border-amber-500/5">
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          ...
          <div className="border-t md:border-t-0 md:border-l border-amber-500/20 pt-6 md:pt-0 pl-0 md:pl-8">
            <p className="text-base md:text-lg leading-7 md:text-8 text-neutral-400 font-light">
      ...
      {/* Services Section */}
      <section className="bg-gradient-to-b from-neutral-950 to-neutral-900/50 px-6 py-20 border-y border-amber-500/5">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div
                key={item.title}
                className="group rounded-3xl border border-neutral-800 bg-neutral-950/50 p-6 md:p-8 shadow-2xl backdrop-blur transition-all duration-300 hover:border-amber-500/30 hover:-translate-y-1"
              >
      ...
      <section id="event" className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-12 md:mb-16 text-center">
          <p className="mb-3 text-xs uppercase tracking-[0.3em] text-amber-400 font-medium">
            Upcoming Events
          </p>
        ...
        <div className="grid gap-8 md:grid-cols-2 justify-center">
          {upcomingEvents.map((event) => (
            <div
              key={event.id}
              className="flex flex-col justify-between rounded-3xl border border-neutral-800 bg-gradient-to-br from-neutral-900 via-black to-black p-6 md:p-8 transition-all duration-300 hover:border-amber-500/20 max-w-xl w-full mx-auto"
            >
              <div>
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  {event.features.map((feature, idx) => (
                    <span key={idx} className="bg-neutral-900 border border-neutral-800 rounded-xl p-3.5 text-xs text-neutral-400 leading-relaxed font-light shifted-text">
                      {feature}
                    </span>
                  ))}
                </div>
              ...
              <button 
                ...
                className="mt-6 md:mt-8 w-full rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 px-6 py-3.5 font-bold text-black transition-all duration-200 hover:scale-[1.01] active:scale-95 active:shadow-[0_0_30px_rgba(245,158,11,0.6)] hover:shadow-[0_0_25px_rgba(245,158,11,0.4)] text-sm md:text-base"
              >
      ...
      <section className="bg-neutral-950 border-t border-amber-500/10 relative overflow-hidden px-6 py-20 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4 px-4">
            <button 
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-amber-500 to-yellow-400 px-8 py-4 text-base md:text-lg font-bold text-black transition-all duration-300 hover:scale-[1.03] active:scale-95 active:shadow-[0_0_30px_rgba(245,158,11,0.6)] hover:shadow-[0_0_25px_rgba(245,158,11,0.35)]"
            >
            ...
            {activeModal === 'book' ? (
              <div>
                ...
                >
                  ...
                  <button type="submit" className="w-full mt-2 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 py-3.5 font-bold text-black transition hover:scale-[1.01] active:scale-95 active:shadow-[0_0_30px_rgba(245,158,11,0.6)] hover:shadow-[0_0_25px_rgba(245,158,11,0.4)] text-sm">
                    Submit Request
                  </button>
                </form>
              </div>

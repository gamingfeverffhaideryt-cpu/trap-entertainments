...
export default function TrapEntertainmentWebsite() {
  ...
  // Immersive Showroom Assets & States
  ...
  return (
    <div className={`min-h-screen bg-neutral-950 text-white font-sans selection:bg-amber-500 selection:text-black transition-opacity duration-1000 ease-out select-none md:cursor-none ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{ scrollBehavior: 'smooth' }}>
      ...
      <section id="event" className="mx-auto max-w-7xl px-6 py-24 border-t border-amber-500/5">
        ...
        >
          <div className="flex items-center justify-center max-w-3xl mx-auto w-full">
            ...
            {/* Immersive Event Showcase Card with details */}
            <div className="group relative flex flex-col md:flex-row rounded-3xl border border-neutral-900 bg-neutral-900/20 shadow-2xl overflow-hidden w-full backdrop-blur-sm transition-all duration-500 hover:border-amber-500/30">
              ...
              {/* Left Side: Filled with lilu.png */}
              <div className="relative w-full md:w-2/5 min-h-[320px] md:min-h-full bg-neutral-950 flex flex-col justify-between p-6 overflow-hidden">
                <img 
                  src="/lilu.png" 
              ...
              <div className="w-full md:w-3/5 p-8 flex flex-col justify-between relative">
                <div>
                  <span className="text-xs uppercase font-bold tracking-[0.2em] text-amber-500/80 block mb-1">Elite Module Configuration</span>
                  ...
                  <p className="text-xs text-neutral-400 font-light max-w-md leading-relaxed mb-6">
                    A high-end conceptual module mapped out for Bangalore's modern lifestyle purists. Join us for a top-tier atmospheric experience.
                  </p>
      ...
      {/* Cinematic Full-Screen Video Layer & Entry Form Crossfade */}
      {isVideoActive && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black overflow-y-auto transform-gpu">
          ...
          {/* Form Container Layer - Smooth fade-in and slide-in from bottom */}
          <div className={`relative w-full max-w-4xl px-4 py-12 my-auto mx-auto z-40 transition-all duration-[1200ms] cubic-bezier(0.16,1,0.3,1) transform-gpu ${
            ...
            <div className="bg-neutral-950/95 border border-neutral-800 rounded-3xl p-6 md:p-10 shadow-2xl relative backdrop-blur-xl">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-start">
                ...
                {/* Column 2: Formspree Processing Engine */}
                <div className="bg-neutral-900/40 border border-neutral-900 rounded-2xl p-6">
                  <form action="https://formspree.io/f/xlgylpaz" method="POST" className="space-y-4">
                    <input type="hidden" name="Event" value="LIILU Techno & Chill feat. MALIK @ Cavore (3rd July)" />
